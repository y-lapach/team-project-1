...
/* PORDUCT MODAL 3 - MILKSHAKE*/
(() => {
  const refs = {
    openMilkshakeBtn: document.querySelector("[data-milkshake-open]"),
    closeMilkshakeBtn: document.querySelector("[data-milkshake-close]"),
    milkshake: document.querySelector("[data-milkshake]"),
  };
